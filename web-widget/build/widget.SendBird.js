...
var _consts = __webpack_require__(31);
...
var _widgetBtn = __webpack_require__(133);

var _widgetBtn2 = _interopRequireDefault(_widgetBtn);

var _listBoard = __webpack_require__(130);

var _listBoard2 = _interopRequireDefault(_listBoard);

var _chatSection = __webpack_require__(129);
...
var _spinner2 = __webpack_require__(132);

var _spinner3 = _interopRequireDefault(_spinner2);

var _sendbird = __webpack_require__(134);
...
var ERROR_MESSAGE_SDK = 'Please import "AppFriends SDK" on first.';
...
var SBWidget = function () {
  ...
  _createClass(SBWidget, [{
    key: 'start',
    value: function start(appId, secret) {
      var _this = this;
    ...
    value: function startWithConnect(appId, sercret, userId, nickname, callback) {
      var _this2 = this;
    ...
    key: '_start',
    value: function _start(appId, sercret) {
      var _this3 = this;
      ...
      this.widgetBtn.addClickEvent(function () {
        _this3.af.isLoggedIn() ? _this3.listBoard.showChannelList() : _this3.listBoard.showLoginForm();
    ...
    value: function _connect(userId, nickname, callback) {
      ...
      this.af.login(userId, nickname, function (token, error) {
    ...
    value: function getChannelList() {
      ...
      this.af.PublicChannel.fetchChannels(function (channelList, error) {
...
var _elements = __webpack_require__(48);
...
var ListBoard = function (_Element) {
  ...
  _createClass(ListBoard, [{
    ...
    value: function createChannelItem() {
      var channelID = arguments.length <= 0 ? undefined : arguments[0];
...
var Sendbird = function () {
  ...
  _createClass(Sendbird, [{
    ...
    value: function createHandlerGlobal() {
      ...
      var channelHandler = new this.af.ChannelHandler();
    ...
    key: 'getMessageTime',
    value: function getMessageTime(time) {
